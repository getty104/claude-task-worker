...
requests, discussions, and other contributions to this repository), and also
...
reported by opening a [GitHub Issue](https://github.com/getty104/claude-task-worker/issues) for non-sensitive matters, or via
[GitHub Security Advisories](https://github.com/getty104/claude-task-worker/security) (Private Vulnerability Reporting) if the report contains
sensitive information that should not be public. All complaints will be
